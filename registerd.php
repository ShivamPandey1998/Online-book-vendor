...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM deliveryperson WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($location_err)&& empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO deliveryperson (username,location,password) VALUES (?,?,?)";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Sign up (DELIVERY PERSON)</h2>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="logind.php" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>